...
public class AdminAddUserWorker extends SwingWorker<UserModel, Void>
	...
	protected UserModel doInBackground() throws Exception {
		...
		this.newUserSalt = this.generateUserSalt();	// Generate the salt that will be used in
													// Hashing the user's password

		this.userNewHashedPassword = this.hashUserPassword();	// Hash the user's password. This will be the
