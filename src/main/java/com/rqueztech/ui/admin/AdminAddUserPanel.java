...
public class AdminAddUserPanel extends JPanel {
	...
	public AdminAddUserPanel(BaseFrame frame, GridBagLayout layout,
		...
		SwingUtilities.invokeLater(() -> {
	        ...
	        this.setPreferredSize(new Dimension(frame.getHeight(),
	        		frame.getWidth()));
	        ...
	        this.setLabelField(AdminAddUserEnums
	        		.FIRSTNAME_LABEL_KEY,"Enter First Name");

	        this.add(this.components.get(AdminAddUserEnums
	        		.FIRSTNAME_LABEL_KEY), this.grid);

	        // Firstname textfield
	        this.grid.gridy += 1;	// Increase vertical grid by one
	        this.setTextField(AdminAddUserEnums
	        		.FIRSTNAME_TEXTFIELD_KEY);	// Set the textfield key

	        this.add(this.components.get(AdminAddUserEnums
	        		.FIRSTNAME_TEXTFIELD_KEY), this.grid);	// Add the component to the grid

	        this.grid.gridy += 1;
	        this.setLabelField(AdminAddUserEnums
	        		.LASTNAME_LABEL_KEY, "Enter Last Name");

	        this.add(this.components.get(AdminAddUserEnums
	        		.LASTNAME_LABEL_KEY), this.grid);
	        ...
	        this.add(this.components.get(AdminAddUserEnums
	        		.LASTNAME_TEXTFIELD_KEY), this.grid);

	        // Passphrase Label
	        this.grid.gridy += 1;
	        this.setLabelField(AdminAddUserEnums
	        		.PASSPHRASE_LABEL_KEY, "Enter Passphrase");

	        this.add(this.components.get(AdminAddUserEnums
	        		.PASSPHRASE_LABEL_KEY), this.grid);
	        ...
	        this.add(this.components.get(AdminAddUserEnums
	        		.PASSPHRASE_TEXTFIELD_KEY), this.grid);

	        // Passphrase button
	        this.grid.gridx += 2;
	        this.setButton(AdminAddUserEnums
	        		.PASSPHRASE_VISIBILITY_BUTTON_KEY, "Visibility");

	        this.add(this.components.get(AdminAddUserEnums
	        		.PASSPHRASE_VISIBILITY_BUTTON_KEY), this.grid);
