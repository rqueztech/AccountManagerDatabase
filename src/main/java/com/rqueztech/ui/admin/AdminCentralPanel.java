	...
	public AdminCentralPanel(BaseFrame frame, GridBagLayout layout,
		...
		SwingUtilities.invokeLater(() -> {
	        ...
	        this.setButton(AdminCentralPanelEnums
	        		.ADMIN_LOGOUT_BUTTON_KEY, "Logout");

	        this.add(this.components.get(AdminCentralPanelEnums
	        		.ADMIN_LOGOUT_BUTTON_KEY), grid);

	        this.grid.gridx += 1;
	        this.setButton(AdminCentralPanelEnums
	        		.USER_VIEW_BUTTON_KEY, "User View");

	        this.add(this.components.get(AdminCentralPanelEnums
	        		.USER_VIEW_BUTTON_KEY), grid);

	        this.grid.gridx += 1;
	        this.setButton(AdminCentralPanelEnums
	        		.ADMIN_ADD_USER_BUTTON_KEY, "Add user");

	        this.add(this.components.get(AdminCentralPanelEnums
	        		.ADMIN_ADD_USER_BUTTON_KEY), grid);
